...
vis_sex <- ggplot(Base_Trajipaq_Finale_Ok %>%
                filter(!is.na(VD1), !is.na(VI4), !is.na(AGE)), aes(x = VI4, y = VD1, color = as.factor(AGE))) +
  geom_jitter(color = "pink") +
  stat_smooth(method = "lm", formula = "y ~ x", se = FALSE) +
...
vis_sex <- ggplot(Base_Trajipaq_Finale_Ok %>%
                filter(!is.na(VD1), !is.na(VI4), !is.na(EDUCATION)), aes(x = VI4, y = VD1, color = as.factor(EDUCATION))) +
  geom_jitter(color = "pink") +
  stat_smooth(method = "lm", formula = "y ~ x", se = FALSE) +
...
vis_sex <- ggplot(Base_Trajipaq_Finale_Ok %>%
                filter(!is.na(VD1), !is.na(VI4), !is.na(ORIGINE)), aes(x = VI4, y = VD1, color = as.factor(ORIGINE))) +
  geom_jitter(color = "pink") +
  stat_smooth(method = "lm", formula = "y ~ x", se = FALSE) +
...
vis_sex <- ggplot(Base_Trajipaq_Finale_Ok %>%
                filter(!is.na(VD1), !is.na(VI4), !is.na(REVENU)), aes(x = VI4, y = VD1, color = as.factor(REVENU))) +
  geom_jitter(color = "pink") +
  stat_smooth(method = "lm", formula = "y ~ x", se = FALSE) +
...
vis_sex <- ggplot(Base_Trajipaq_Finale_Ok %>%
                filter(!is.na(VD1), !is.na(VI4), !is.na(LANGUE)), aes(x = VI4, y = VD1, color = as.factor(LANGUE))) +
  geom_jitter(color = "pink") +
  stat_smooth(method = "lm", formula = "y ~ x", se = FALSE) +
...
vis_sex <- ggplot(Base_Trajipaq_Finale_Ok %>%
                filter(!is.na(VD1), !is.na(VI4), !is.na(RELIGION)), aes(x = VI4, y = VD1, color = as.factor(RELIGION))) +
  geom_jitter(color = "pink") +
  stat_smooth(method = "lm", formula = "y ~ x", se = FALSE) +
...
vis_sex <- ggplot(Base_Trajipaq_Finale_Ok %>%
                filter(!is.na(VD1), !is.na(VI4), !is.na(MATRIMONIAL)), aes(x = VI4, y = VD1, color = as.factor(MATRIMONIAL))) +
  geom_jitter(color = "pink") +
  stat_smooth(method = "lm", formula = "y ~ x", se = FALSE) +
