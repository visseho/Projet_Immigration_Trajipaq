...
```{r}
Base_Trajipaq_Finale_Ok <- read_dta("C:/Users/Théo CARLIER/OneDrive/Bureau/Base_Trajipaq_Finale_Ok.dta")
```
...
Base_Trajipaq_Finale_Ok <-
  Base_Trajipaq_Finale_Ok %>%
  mutate(I1_F = case_when(
    I1 < 0.25 ~ "Faible",
    I1 >= 0.25 & I1 < 0.5 ~ "Moyen",
    I1 >= 0.5 & I1 < 0.75 ~ "Fort",
    I1 >= 0.75 & I1 <= 1 ~ "Tres fort",
  ))

Base_Trajipaq_Finale_Ok$I1_F <- factor(Base_Trajipaq_Finale_Ok$I1_F, levels = c("Tres fort",
                                                                                "Fort",
                                                                                "Moyen",
                                                                                "Faible"
                                                                                ), ordered = TRUE)
...
Base_Trajipaq_Finale_Ok <-
  Base_Trajipaq_Finale_Ok %>%
  mutate(I2_F = case_when(
    I2 < 0.25 ~ "Faible",
    I2 >= 0.25 & I2 < 0.5 ~ "Moyen",
    I2 >= 0.5 & I2 < 0.75 ~ "Fort",
    I2 >= 0.75 & I2 <= 1 ~ "Tres fort",
  ))

Base_Trajipaq_Finale_Ok$I2_F <- factor(Base_Trajipaq_Finale_Ok$I2_F, levels = c("Tres fort",
                                                                                "Fort",
                                                                                "Moyen",
                                                                                "Faible"
                                                                                ), ordered = TRUE)
...
ctable(x = Base_Trajipaq_Finale_Ok$I2_F, y = Base_Trajipaq_Finale_Ok$I1_F)

```

```{r}

ggplot(data = Base_Trajipaq_Finale_Ok, mapping = aes(x = I2_F, fill = I1_F)) +
...
chisq.test(x = Base_Trajipaq_Finale_Ok$I2_F, y = Base_Trajipaq_Finale_Ok$I1_F)
