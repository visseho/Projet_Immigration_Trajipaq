...
## VD1 : L'indice du sentiment d'appartenance au Québec
...
Base_Trajipaq_Finale_Ok <-
  ...
  mutate(VD1_F = case_when(
    VD1 < 0.25 ~ "Faible",
    VD1 >= 0.25 & VD1 < 0.5 ~ "Moyen",
    VD1 >= 0.5 & VD1 < 0.75 ~ "Fort",
    VD1 >= 0.75 & VD1 <= 1 ~ "Tres fort",
  ))

Base_Trajipaq_Finale_Ok$VD1_F <- factor(Base_Trajipaq_Finale_Ok$VD1_F, levels = c("Tres fort",
                                                                                "Fort",
                                                                                "Moyen",
                                                                                "Faible"
                                                                                ), ordered = TRUE)
...
ctable(x = Base_Trajipaq_Finale_Ok$VI1_F, y = Base_Trajipaq_Finale_Ok$VD1_F)

```

```{r}

ggplot(data = Base_Trajipaq_Finale_Ok, mapping = aes(x = VI1_F, fill = VD1_F)) +
...
chisq.test(x = Base_Trajipaq_Finale_Ok$VI1_F, y = Base_Trajipaq_Finale_Ok$VD1_F)
...
reg_1 <- lm(Base_Trajipaq_Finale_Ok$VI1 ~ Base_Trajipaq_Finale_Ok$VD1 +
...
cor.test(Base_Trajipaq_Finale_Ok$VI1, Base_Trajipaq_Finale_Ok$VD1)
...
vis <- ggplot(Base_Trajipaq_Finale_Ok %>%
                filter(!is.na(VD1), !is.na(VI1)), aes(x = VI1, y = VD1)) +
...
vis_sex <- ggplot(Base_Trajipaq_Finale_Ok %>%
                filter(!is.na(VD1), !is.na(VI1), !is.na(Q10)), aes(x = VI1, y = VD1, color = as.factor(Q10))) +
  geom_jitter(color = "pink") +
...
vis_age <- ggplot(Base_Trajipaq_Finale_Ok %>%
                filter(!is.na(VD1), !is.na(VI1), !is.na(Q8A_F)), aes(x = VI1, y = VD1, color = Q8A_F)) +
  geom_jitter(color = "pink") +
  stat_smooth(method = "lm", formula = "y ~ x", se = FALSE) +
...
vis_born <- ggplot(Base_Trajipaq_Finale_Ok %>%
                filter(!is.na(VD1), !is.na(VI1), !is.na(STATUT_F)), aes(x = VI1, y = VD1, color = STATUT_F)) +
  geom_jitter(color = "pink") +
  stat_smooth(method = "lm", formula = "y ~ x", se = FALSE) +
...
vis_born <- ggplot(Base_Trajipaq_Finale_Ok %>%
                filter(!is.na(VD1), !is.na(VI1), !is.na(Q4)), aes(x = VI1, y = VD1, color = as.factor(Q4))) +
  geom_jitter(color = "pink") +
  stat_smooth(method = "lm", formula = "y ~ x", se = FALSE) +
...
vis_educ <- ggplot(Base_Trajipaq_Finale_Ok %>%
                filter(!is.na(VD1), !is.na(VI1), !is.na(Q16)), aes(x = VI1, y = VD1, color = as.factor(Q16))) +
  geom_jitter(color = "pink") +
  stat_smooth(method = "lm", formula = "y ~ x", se = FALSE) +
...
vis_relig <- ggplot(Base_Trajipaq_Finale_Ok %>%
                filter(!is.na(VD1), !is.na(VI1), !is.na(Q17_F)), aes(x = VI1, y = VD1, color = Q17_F)) +
  geom_jitter(color = "pink") +
  stat_smooth(method = "lm", formula = "y ~ x", se = FALSE) +
...
vis_lang <- ggplot(Base_Trajipaq_Finale_Ok %>%
                filter(!is.na(VD1), !is.na(VI1), !is.na(Q20_F)), aes(x = VI1, y = VD1, color = Q20_F)) +
  geom_jitter(color = "pink") +
  stat_smooth(method = "lm", formula = "y ~ x", se = FALSE) +
...
vis_health <- ggplot(Base_Trajipaq_Finale_Ok %>%
                filter(!is.na(VD1), !is.na(VI1), !is.na(Q23)), aes(x = VI1, y = VD1, color = as.factor(Q23))) +
  geom_jitter(color = "pink") +
  stat_smooth(method = "lm", formula = "y ~ x", se = FALSE) +
