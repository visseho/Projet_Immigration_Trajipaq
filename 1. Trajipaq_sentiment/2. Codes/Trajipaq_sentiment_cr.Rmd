...
trajipaq <-
  ...
  mutate(origine = case_when( # Création de la variable "region".
    ...
    region_naissance == "Caraibes" ~ "Autres",
...
trajipaq <-
  trajipaq %>%
  mutate(VD2_long = case_when( # Création de la variable "VD2".
    Q39E == 1 ~ 1,
    Q39E == 2 ~ 2,
    Q39E == 3 ~ 3,
    Q39E == 4 ~ 4,
...
trajipaq <-
  trajipaq %>%
  mutate(VD2_dico = case_when( # Création de la variable "VD2".
    Q39E == 1 ~ 1,
    Q39E == 2 ~ 1,
    Q39E == 3 ~ 0,
    Q39E == 4 ~ 0,
...
trajipaq <-
  ...
  mutate(VD4 = case_when( # Création de la variable "VD4".
    VD2_dico == "Oui" & VD3 == "Oui" ~ "Integre",
    VD2_dico == "Oui" & VD3 == "Non" ~ "Assimile",
    VD2_dico == "Non" & VD3 == "Oui" ~ "Separe",
    VD2_dico == "Non" & VD3 == "Non" ~ "Marginalise"
  ))
