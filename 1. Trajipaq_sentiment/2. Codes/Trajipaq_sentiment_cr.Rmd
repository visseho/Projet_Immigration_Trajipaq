...
trajipaq <-
  ...
  mutate(sentimapp_can_origin_N = case_when( # Création de la variable "VD4".
    sentimapp_can_dico == 1 & sentimapp_origine_dico == 1 ~ "1",
    sentimapp_can_dico == 1 & sentimapp_origine_dico == 0 ~ "2",
    sentimapp_can_dico == 0 & sentimapp_origine_dico == 1 ~ "3",
    sentimapp_can_dico == 0 & sentimapp_origine_dico == 0 ~ "4"
  ))
