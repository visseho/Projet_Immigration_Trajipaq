...
reg_WGI_can1 <- glm(formula = VD2_dico ~ vae_arrival, data = trajipaq, family = "binomial") # VD2 dichotomique
reg_WGI_can1_ctrl <- glm(formula = VD2_dico ~ vae_arrival  + age + education + sexe + origine + revenu + langue_mat + religion + statut_mat , data = trajipaq, family = "binomial") #VD2 contrôlée par CSD

summary(reg_WGI_can1)
summary(reg_WGI_can1_ctrl)

# Au moment de l'enquête (like)

reg_WGI_can2 <- glm(formula = VD2_dico ~ vae_2021 , data = trajipaq, family = "binomial") # VD2 non regroupée
reg_WGI_can2_ctrl <- glm(formula = VD2_dico ~ vae_2021  + age + education + sexe + origine + revenu + langue_mat + religion + statut_mat , data = trajipaq, family = "binomial")#VD2 contrôlée par CSD


summary(reg_WGI_can2)
summary(reg_WGI_can2_ctrl)

# À l'arrivée et au moment de l'enquête

reg_WGI_can3 <- glm(formula = VD2_dico ~ vae_2021 + vae_arrival , data = trajipaq, family = "binomial") # VD2 non regroupée
reg_WGI_can3_ctrl <- glm(formula = VD2_dico ~ vae_2021 + vae_arrival + age + education + sexe + origine + revenu + langue_mat + religion + statut_mat , data = trajipaq, family = "binomial")# VD2 contrôlée par CSD


summary(reg_WGI_can3)
summary(reg_WGI_can3_ctrl)
...
reg_WGI_qc1 <- lm(formula = VD1  ~ vae_arrival, data = trajipaq) # VD1
